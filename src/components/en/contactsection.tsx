// src/components/en/contactsection.tsx
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="lg:pr-12">
              ...
              <div className="space-y-6 text-gray-600 text-lg">
                <p>
                  We understand that implementing AI automation can seem complex at first. That's why we're here to guide you every step of the way.
                </p>
                
                <p>
                  – Our team of experts is ready to analyze your processes and show you how AI can transform your business operations, saving you time and boosting efficiency.
                </p>
              </div>
            </div>
