...
import benefitsImage from "figma:asset/95dc6c5f0091b5e3cde65c10bff560a1ce2c4d42.png";

const benefits = [
  "Réduction des coûts opérationnels jusqu'à 60%",
  "Augmentation de la productivité de votre équipe",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-300 mb-8">
              ...
              Les entreprises qui adoptent l'automatisation maintenant prennent une longueur d'avance.
            </p>
